...
const Contact = () => {
  ...
  const formik = useFormik<FormValues>({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        ...
        await axios.post(
          "https://forminit.com/f/flynwmb05ie",
          formData,
        );
  ...
  return (
    <section id="contact">
      <div
        className={`box-border w-full h-screen ${isDarkMode ? "bg-black text-white" : "bg-white text-black"
        ...
        <div className="flex flex-col p-4 justify-center max-w-screen-lg mx-auto">
          ...
          <div className="flex justify-between items-center gap-6">
            ...
            >
              ...
              <button
                type="submit"
                className={`w-full bg-blue-500 text-white p-3 rounded-md hover:bg-blue-600 ${isSubmitting ? "opacity-50 cursor-not-allowed" : ""
                  }`}
